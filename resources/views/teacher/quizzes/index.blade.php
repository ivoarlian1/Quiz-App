        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('teacher.quizzes.index') }}">My Quizzes</a>
                    </li>
                </ul>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('teacher.quizzes.show', $quiz) }}" class="btn btn-sm btn-primary">
                                                        <i class="bi bi-eye"></i> View
                                                    </a>
                                                    <a href="{{ route('teacher.quizzes.results', $quiz) }}" class="btn btn-sm btn-success">
                                                        <i class="bi bi-download"></i> Results
                                                    </a>
                                                    <form action="{{ route('teacher.quizzes.toggle', $quiz) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        <button type="submit" class="btn btn-sm btn-{{ $quiz->is_active ? 'warning' : 'success' }}">
