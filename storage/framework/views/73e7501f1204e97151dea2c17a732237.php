...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Neuro Quiz'); ?></title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(url('/')); ?>">Neuro Quiz</a>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php else: ?>
                        <?php if(auth()->user()->role === 'teacher'): ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('teacher.quizzes.index')); ?>">Quizzes</a>
                            </li>
