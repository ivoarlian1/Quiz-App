<?php $__env->startSection('title', 'Login - Neuro Quiz'); ?>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-primary">Don't have an account? Register</a>
                    </div>
                </form>
            </div>
        </div>
